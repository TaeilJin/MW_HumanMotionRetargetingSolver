...
int mgPoseIKSolver::addDesiredPair(std::vector<gVec3> desiredPoses)
{
	addDesiredObjective("t0", 1.0, desiredPoses[0]); // hips *
	addDesiredObjective("t1", 0.1, desiredPoses[1]); // Spine
	addDesiredObjective("t2", 0.1, desiredPoses[2]); // Spine1
	addDesiredObjective("t3", 1.0, desiredPoses[3]); // Spine2 *
	addDesiredObjective("t4", 0.1, desiredPoses[4]); // Neck
	addDesiredObjective("t5", 1.0, desiredPoses[5]); // Head *

	//addDesiredObjective("t6", 1.0, desiredPoses[6]); // LeftShoulder
	addDesiredObjective("t7", 0.1, desiredPoses[7]);  // LeftForeArm
	addDesiredObjective("t8", 0.1, desiredPoses[8]); // LeftArm
	addDesiredObjective("t9", 1.0, desiredPoses[9]); // LeftHand *

	//addDesiredObjective("t10", 1.0, desiredPoses[10]); // RightShoulder
	addDesiredObjective("t11", 0.1, desiredPoses[11]); // RightForeArm
	addDesiredObjective("t12", 0.1, desiredPoses[12]); // RightArm
	addDesiredObjective("t13", 1.0, desiredPoses[13]); // RightHand *
	
	addDesiredObjective("t14", 1.0, desiredPoses[14]); // RightUpLeg
	addDesiredObjective("t15", 0.1, desiredPoses[15]); // RightLeg
	addDesiredObjective("t16", 0.1, desiredPoses[16]); // RightFoot
	addDesiredObjective("t17", 1.0, desiredPoses[17]); // RightToeBase *

	addDesiredObjective("t18", 1.0, desiredPoses[18]); // LeftUpLeg
	addDesiredObjective("t19", 0.1, desiredPoses[19]); // LeftLeg
	addDesiredObjective("t20", 0.1, desiredPoses[20]); // LeftFoot
	addDesiredObjective("t21", 1.0, desiredPoses[21]); // LeftToeBase *
	...
	//addDesiredObjective("t21", 1.0, desiredPoses[21]);
	return 0;
}
...
int mgPoseIKSolver::transferDesiredPoseLevMar(gXMat& offset, std::vector<gVec3> desiredJointPos)
{
