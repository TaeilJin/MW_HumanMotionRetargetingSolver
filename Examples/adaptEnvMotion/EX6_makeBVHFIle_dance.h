...
public:
	...
	mgPoseTransfer_dance* g_poseTrans;
	...
	// 2. save all bvh after IK
	void saveAllMakedMotion(std::vector<char*> srcFiles, std::vector<char*> rootname, char* targetPath);
};
