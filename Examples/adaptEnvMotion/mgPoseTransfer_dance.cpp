...
#include "mgPoseTransfer_dance.h"
...
{		
	mgPoseTransfer_dance* pt = (mgPoseTransfer_dance*)adata;

	assert( n == (pt->positions.size()*3+pt->directions.size()*3+pt->tar->dof()-6) );
...
*/
int		mgPoseTransfer_dance::transferPoseLevMar(gXMat& offset)
{
...
int mgPoseTransfer_dance::addDesiredPair(std::vector<gVec3> desiredPoses)
{
...
int mgPoseTransfer_dance::transferDesiredPoseLevMar(gXMat& offset, std::vector<gVec3> desiredJointPos)
{
...
*/
bool mgPoseTransfer_dance::addDirectionObjective(const char* pointName0, const char* pointName1, double weight)
{
	int pointIndex0 = -1;
	int pointIndex1 = -1;
...
weight: importance of this objective
*/
bool mgPoseTransfer_dance::addPositionObjective(const char* pointName, double weight)
{
	int pointIndex = -1;
...
bool mgPoseTransfer_dance::addPositionObjective(const char* pointName, double weight, double scale)
{
	int pointIndex = -1;
...
bool mgPoseTransfer_dance::addDesiredObjective(const char* pointName, double weight, gVec3 desiredpos)
{
	int pointIndex = -1;
