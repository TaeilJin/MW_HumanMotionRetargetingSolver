...
void EX4_retargetmotion::UpdateScene(int even_simulationTime, int even_iter, bool b_motionretarget)
{
	//
...
void EX4_retargetmotion::retargetPose(bool bool_motionretarget)
{
...
void EX4_retargetmotion::saveRetargetMotion(bool bool_save, char* tarBVHFILE, float frametime)
{
	if (bool_save) {
